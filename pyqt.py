    ...
    def init_ui(self):
        ...
        if not _key.startswith("sk-"):
            QMessageBox.critical(
                self,
                "Hey!",
                "API Key not found, or an invalid API key was provided. Set a " "valid key in api-key.txt!",
            )
            sys.exit()
        openai.api_key = _key
        ...
        exclude = ["instruct", "similarity", "code", "if", "query", "document", "insert", ":", "text-search"]
